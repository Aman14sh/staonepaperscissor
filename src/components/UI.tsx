 ...
 function win_helper(num:number,selc:null | string){
  ...
  return (
    ...
    <div className='score flex justify-between'>
      ...
      <div className='user flex items-center justify-center  w-[100px] h-[100px] ml-[60px]'>
      ...
      <div className='comp  w-[100px] flex items-center justify-center h-[100px] mr-[200px] mt-[20px]' >
        <img className="w-[50px] "
